...
var theme_service_1 = __webpack_require__(/*! ./services/theme/theme.service */ "./src/app/services/theme/theme.service.ts");
...
var grid_example_component_1 = __webpack_require__(/*! ./components/grid-example/grid-example.component */ "./src/app/components/grid-example/grid-example.component.ts");
var tablejs_module_1 = __webpack_require__(/*! ./tablejs/tablejs.module */ "./src/app/tablejs/tablejs.module.ts");
var frames_per_second_module_1 = __webpack_require__(/*! ./fps/frames-per-second.module */ "./src/app/fps/frames-per-second.module.ts");
var phone_pipe_1 = __webpack_require__(/*! ./pipes/phone.pipe */ "./src/app/pipes/phone.pipe.ts");
var cell_validator_service_1 = __webpack_require__(/*! ./services/cell-validator/cell-validator.service */ "./src/app/services/cell-validator/cell-validator.service.ts");
var phone_filter_component_1 = __webpack_require__(/*! ./components/phone-filter/phone-filter.component */ "./src/app/components/phone-filter/phone-filter.component.ts");
var overlay_1 = __webpack_require__(/*! @angular/cdk/overlay */ "./node_modules/@angular/cdk/esm5/overlay.es5.js");
var material_1 = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
var transaction_grid_component_1 = __webpack_require__(/*! ./components/grid-example/transaction-grid/transaction-grid.component */ "./src/app/components/grid-example/transaction-grid/transaction-grid.component.ts");
var print_overlay_component_1 = __webpack_require__(/*! ./components/print-overlay/print-overlay.component */ "./src/app/components/print-overlay/print-overlay.component.ts");
var selected_filter_component_1 = __webpack_require__(/*! ./components/selected-filter/selected-filter.component */ "./src/app/components/selected-filter/selected-filter.component.ts");
var export_to_excel_overlay_component_1 = __webpack_require__(/*! ./components/export-to-excel-overlay/export-to-excel-overlay.component */ "./src/app/components/export-to-excel-overlay/export-to-excel-overlay.component.ts");
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var export_to_excel_overlay_tokens_1 = __webpack_require__(/*! ./export/export-to-excel-overlay-tokens */ "./src/app/components/export-to-excel-overlay/export/export-to-excel-overlay-tokens.ts");
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
var theme_service_1 = __webpack_require__(/*! ./../../services/theme/theme.service */ "./src/app/services/theme/theme.service.ts");
var export_options_service_1 = __webpack_require__(/*! ./../../services/export/export-options/export-options.service */ "./src/app/services/export/export-options/export-options.service.ts");
var excel_service_1 = __webpack_require__(/*! ./../../services/excel/excel.service */ "./src/app/services/excel/excel.service.ts");
var ExportToExcelOverlayComponent = /** @class */ (function () {
    function ExportToExcelOverlayComponent(data, fb, themeService, exportOptionsService, elementRef, excelService) {
        this.data = data;
        this.fb = fb;
        this.themeService = themeService;
    ...
    ExportToExcelOverlayComponent.prototype.ngOnInit = function () {
        var _this = this;
        var lastEmit = this.exportOptionsService.lastEmit;
        this.exportOptionsService.exportOptionEmitter = this.exportOptionEmitter;
        this.themeService.themes.forEach(function (theme) {
            _this.elementRef.nativeElement.classList.add(theme);
        });
        ...
        this.form.valueChanges.subscribe(function (res) {
            _this.updateExportableItems(_this.form.controls['selectedRecordsOnly'].value);
        });
        this.updateExportableItems(this.form.controls['selectedRecordsOnly'].value);
    };
    ExportToExcelOverlayComponent.prototype.updateExportableItems = function (selectedOnly) {
        this.exportableItems = selectedOnly ? this.getSelectedExportableItems() : this.data.exportableItems;
    };
    ExportToExcelOverlayComponent.prototype.getSelectedExportableItems = function () {
        return this.data.exportableItems.filter(function (item) { return item.selected; });
    };
    ExportToExcelOverlayComponent.prototype.onSubmit = function (form) {
        if (form.invalid) {
            return;
        }
    ...
    ExportToExcelOverlayComponent.prototype.closeExportToExcelModal = function () {
        this.closeEmitter.emit();
    };
    ExportToExcelOverlayComponent.ctorParameters = function () { return [
    ...
    return ExportToExcelOverlayComponent;
}());
...
var phone_filter_component_1 = __webpack_require__(/*! ./../phone-filter/phone-filter.component */ "./src/app/components/phone-filter/phone-filter.component.ts");
var selected_filter_component_1 = __webpack_require__(/*! ./../selected-filter/selected-filter.component */ "./src/app/components/selected-filter/selected-filter.component.ts");
var filter_overlay_tokens_1 = __webpack_require__(/*! ./../phone-filter/filters/filter-overlay-tokens */ "./src/app/components/phone-filter/filters/filter-overlay-tokens.ts");
var print_overlay_tokens_1 = __webpack_require__(/*! ./../print-overlay/print/print-overlay-tokens */ "./src/app/components/print-overlay/print/print-overlay-tokens.ts");
var export_to_excel_overlay_tokens_1 = __webpack_require__(/*! ./../export-to-excel-overlay/export/export-to-excel-overlay-tokens */ "./src/app/components/export-to-excel-overlay/export/export-to-excel-overlay-tokens.ts");
var selected_overlay_tokens_1 = __webpack_require__(/*! ./../selected-filter/selected/selected-overlay-tokens */ "./src/app/components/selected-filter/selected/selected-overlay-tokens.ts");
var filter_service_1 = __webpack_require__(/*! ./../../services/filter/filter.service */ "./src/app/services/filter/filter.service.ts");
var grid_data_service_1 = __webpack_require__(/*! ./../../services/grid-data/grid-data.service */ "./src/app/services/grid-data/grid-data.service.ts");
var filter_type_1 = __webpack_require__(/*! ../../shared/classes/filter-type */ "./src/app/shared/classes/filter-type.ts");
var theme_service_1 = __webpack_require__(/*! ./../../services/theme/theme.service */ "./src/app/services/theme/theme.service.ts");
var print_overlay_component_1 = __webpack_require__(/*! ./../print-overlay/print-overlay.component */ "./src/app/components/print-overlay/print-overlay.component.ts");
var export_to_excel_overlay_component_1 = __webpack_require__(/*! ./../export-to-excel-overlay/export-to-excel-overlay.component */ "./src/app/components/export-to-excel-overlay/export-to-excel-overlay.component.ts");
var transaction_grid_component_1 = __webpack_require__(/*! ./transaction-grid/transaction-grid.component */ "./src/app/components/grid-example/transaction-grid/transaction-grid.component.ts");
var excel_service_1 = __webpack_require__(/*! ./../../services/excel/excel.service */ "./src/app/services/excel/excel.service.ts");
var GridExampleComponent = /** @class */ (function () {
    function GridExampleComponent(cellValidatorService, overlay, injector, filterService, gridDataService, themeService, excelService, cdr) {
    ...
    GridExampleComponent.prototype.ngAfterViewInit = function () {
    };
    GridExampleComponent.prototype.onKeydownHandler = function (event) {
    ...
    GridExampleComponent.prototype.beforePrint = function () {
    };
    GridExampleComponent.prototype.afterPrint = function () {
        this.resetItemsAfterPrint();
    };
    GridExampleComponent.prototype.resetItemsAfterPrint = function () {
        var _this = this;
        this.printing = false;
        var items = this.printItems;
        this.sortedAndFilteredItems = [];
        setTimeout(function () {
            _this.sortedAndFilteredItems = items;
            _this.sortedAndFilteredItems.forEach(function (item) {
                item.printing = false;
    ...
    GridExampleComponent.prototype.print = function (e) {
        e.preventDefault();
        e.stopImmediatePropagation();
        this.openPrintPreview();
    };
    GridExampleComponent.prototype.exportToExcel = function (e) {
        this.openExportToExcelOverlay();
    };
    GridExampleComponent.prototype.openPrintPreview = function () {
        clearInterval(this.printPreviewInterval);
        this.openPrintOverlay();
    };
    GridExampleComponent.prototype.setItems = function (itemCount) {
        this.baseItems = this.gridDataService.generateGridData(itemCount);
        this.baseItems.forEach(function (item) {
            item.selected = false;
            item.printing = false;
        });
    ...
    GridExampleComponent.prototype.filterGridByText = function (e) {
        var target = e.target;
        var filterOption = {
            varName: null,
        ...
        var existingFilter = this.filterService.getExistingFilter(this.filterOptions, filterOption);
        if (existingFilter) {
    ...
    GridExampleComponent.prototype.filterItems = function (arr, filterOptions) {
    ...
    GridExampleComponent.prototype.calculateUserRatingPerc = function (rating) {
        return rating / 5;
    };
    GridExampleComponent.prototype.getRoundedRatingText = function (rating) {
    ...
    GridExampleComponent.prototype.rowsSelected = function (e) {
        var target = e.target;
        this.setItems(Number(target.value));
        this.mainViewPort.scrollToOffset(0);
    };
    GridExampleComponent.prototype.themeColorSelected = function (e) {
        var target = e.target;
        this.themeService.setThemeColor(target.value);
    };
    GridExampleComponent.prototype.themeSizeSelected = function (e) {
        var target = e.target;
        this.themeService.setThemeSize(target.value);
    };
    GridExampleComponent.prototype.toggleResize = function (e) {
        this.resizeEnabled = !this.resizeEnabled;
    };
    GridExampleComponent.prototype.toggleReorder = function (e) {
        this.reorderEnabled = !this.reorderEnabled;
    };
    GridExampleComponent.prototype.toggleCellEditability = function (e) {
        this.editableCellsEnabled = !this.editableCellsEnabled;
    };
    GridExampleComponent.prototype.toggleColumnSortability = function (e) {
        this.sortableColumnsEnabled = !this.sortableColumnsEnabled;
    };
    GridExampleComponent.prototype.toggleCollapse = function (item) {
    ...
    GridExampleComponent.prototype.animationEnd = function (expandData, e) {
        expandData.wasOpened = e.animationName === 'uncollapseRowAnimation';
    };
    /* Start Editable Cell Functions */
    GridExampleComponent.prototype.onEditableCellInput = function (item, varName, content) {
    ...
    GridExampleComponent.prototype.onEditableCellValidated = function (e) { };
    GridExampleComponent.prototype.onEditableCellFocusOut = function (e) { };
    /* End Editable Cell Functions */
    /* Start Sort Functions */
    GridExampleComponent.prototype.sortByVar = function (varName) {
        var _this = this;
        this.sortedAndFilteredItems = this.filterItems(this.baseItems, this.filterOptions);
        ...
        this.sortedAndFilteredItems = this.sortedAndFilteredItems.sort(function (item1, item2) {
    ...
    GridExampleComponent.prototype.openExportToExcelOverlay = function () {
        ...
        var injector = this.createInjector({ exportableItems: this.sortedAndFilteredItems }, export_to_excel_overlay_tokens_1.EXPORT_TO_EXCEL_OVERLAY_DATA);
        var containerPortal = new portal_1.ComponentPortal(export_to_excel_overlay_component_1.ExportToExcelOverlayComponent, null, injector);
        var containerRef = overlayRef.attach(containerPortal);
        var component = containerRef.instance;
        component.closeEmitter.subscribe(function () {
            overlayRef.detach();
        });
    };
    GridExampleComponent.prototype.openPrintOverlay = function () {
        var _this = this;
        var positionStrategy = this.overlay
            .position()
            .global()
        ...
        var overlayRef = this.overlay.create(overlayConfig);
        // Create ComponentPortal that can be attached to a PortalHost
        var injector = this.createInjector({ printableItems: this.sortedAndFilteredItems, containsPrintableItems: true }, print_overlay_tokens_1.PRINT_OVERLAY_DATA);
        var containerPortal = new portal_1.ComponentPortal(print_overlay_component_1.PrintOverlayComponent, null, injector);
        var containerRef = overlayRef.attach(containerPortal);
        var component = containerRef.instance;
        component.closeEmitter.subscribe(function () {
            overlayRef.detach();
        });
        component.printOptionEmitter.subscribe(function (printOptions) {
            var numOfRows = printOptions.rowEnd - printOptions.rowStart + 1;
            _this.printItems = _this.sortedAndFilteredItems.concat();
            if (printOptions.selectedRowsOnly) {
                var printFilterOption = {
                    varName: 'selected',
                    filterType: filter_type_1.FilterType.EXACT_MATCH,
                    validFilterValues: [true]
                };
                _this.sortedAndFilteredItems = _this.filterService.filter(_this.sortedAndFilteredItems, printFilterOption);
            }
            _this.sortedAndFilteredItems = _this.sortedAndFilteredItems.slice(printOptions.rowStart - 1, printOptions.rowEnd);
            ...
            var hgt = printOptions.printHeight;
            _this.mainViewPort.elementRef.nativeElement.style.height = (hgt).toString() + 'px';
            _this.mainViewPort.checkViewportSize();
            _this.printing = true;
            var performAnimation = function () {
                if (!_this.mainViewPort) {
                    console.log('no valid print data');
                    clearInterval(_this.printInterval);
                    injector.get(print_overlay_tokens_1.PRINT_OVERLAY_DATA).containsPrintableItems = false;
                    _this.resetItemsAfterPrint();
                    return;
                }
                _this.transactionViewPorts.forEach(function (transactionViewport) {
                    if (!transactionViewport.item.collapsed) {
                        transactionViewport.viewPort.checkViewportSize();
                    }
                });
                _this.mainViewPort.checkViewportSize();
                if (_this.mainViewPort.elementRef.nativeElement.clientHeight === hgt) {
                    clearInterval(_this.printInterval);
                    overlayRef.detach();
                    _this.printPreviewInterval = setTimeout(function () {
                        window.print();
                        return false;
                    }, 1);
                }
            ...
            _this.printInterval = setTimeout(performAnimation, 50);
        });
    };
    GridExampleComponent.prototype.openPhoneSort = function (e) {
        var _this = this;
        e.preventDefault();
        e.stopImmediatePropagation();
        var el = e.target;
        ...
        var overlayRef = this.overlay.create(overlayConfig);
        // Create ComponentPortal that can be attached to a PortalHost
        var injector = this.createInjector({ allAreaCodes: this.gridDataService.areaCodes, selectedAreaCodes: this.selectedAreaCodes }, filter_overlay_tokens_1.FILTER_OVERLAY_DATA);
        var containerPortal = new portal_1.ComponentPortal(phone_filter_component_1.PhoneFilterComponent, null, injector);
        var containerRef = overlayRef.attach(containerPortal);
        var component = containerRef.instance;
        component.filterOptionEmitter.subscribe(function (filterOption) {
            var existingFilter = _this.filterService.getExistingFilter(_this.filterOptions, filterOption);
            if (existingFilter) {
            ...
            _this.selectedAreaCodes = filterOption.validFilterValues.concat();
            _this.sortedAndFilteredItems = _this.filterItems(_this.baseItems, _this.filterOptions);
            if (!!_this.lastSortVarName) {
                _this.sortDirection *= -1;
                _this.sortByVar(_this.lastSortVarName);
            }
        });
    ...
    GridExampleComponent.prototype.openSelectedSort = function (e) {
        var _this = this;
        e.preventDefault();
        e.stopImmediatePropagation();
        var el = e.target;
        ...
        var overlayRef = this.overlay.create(overlayConfig);
        // Create ComponentPortal that can be attached to a PortalHost
        var injector = this.createInjector({ selectedRowVisibilityOptions: this.selectedRowVisibilityOptions }, selected_overlay_tokens_1.SELECTED_OVERLAY_DATA);
        var containerPortal = new portal_1.ComponentPortal(selected_filter_component_1.SelectedFilterComponent, null, injector);
        var containerRef = overlayRef.attach(containerPortal);
        var component = containerRef.instance;
        component.filterOptionEmitter.subscribe(function (filterOption) {
            var existingFilter = _this.filterService.getExistingFilter(_this.filterOptions, filterOption);
            ...
            _this.selectedRowVisibilityOptions = filterOption.validFilterValues;
            _this.sortedAndFilteredItems = _this.filterItems(_this.baseItems, _this.filterOptions);
            if (!!_this.lastSortVarName) {
                _this.sortDirection *= -1;
                _this.sortByVar(_this.lastSortVarName);
    ...
    GridExampleComponent.prototype.createInjector = function (dataToPass, token) {
    ...
    GridExampleComponent.prototype.sortedDown = function (varName) {
        return varName === this.lastSortVar && this.sortDirection === 1;
    };
    GridExampleComponent.prototype.sortedUp = function (varName) {
        return varName === this.lastSortVar && this.sortDirection === -1;
    };
    GridExampleComponent.prototype.setRowCheckId = function (index) {
        return 'row-selection-check-' + index;
    };
    GridExampleComponent.prototype.rowSelectionChanged = function (e, item) {
        var target = e.target;
    ...
    GridExampleComponent.prototype.selectAllRowsChanged = function (e) {
        var target = e.target;
        this.baseItems.forEach(function (item) {
            item.selected = target.checked;
        });
    ...
    GridExampleComponent.prototype.isIndeterminate = function () {
    ...
    GridExampleComponent.prototype.dragDropFilter = function (el) {
    ...
    GridExampleComponent.prototype.columnResizeStart = function (e) { };
    // Triggered when a parent column row is resized via a mouse movemenet
    GridExampleComponent.prototype.columnResize = function (e) { };
    // Triggered when a parent column row is resize is completed
    GridExampleComponent.prototype.columnResizeEnd = function (e) { };
    // Triggered when a parent column reorder begins
    GridExampleComponent.prototype.columnReorderStart = function (e) { };
    // Triggered when a parent column is being reordered
    GridExampleComponent.prototype.columnReorder = function (e) { };
    // Triggered when a parent column reorder ends
    GridExampleComponent.prototype.columnReorderEnd = function (e) { };
...
var TransactionGridComponent = /** @class */ (function () {
    function TransactionGridComponent(elementRef, themeService, gridDataService, filterService) {
        this.elementRef = elementRef;
        this.themeService = themeService;
        this.gridDataService = gridDataService;
        this.filterService = filterService;
    ...
    TransactionGridComponent.prototype.ngAfterViewInit = function () {
    };
    TransactionGridComponent.prototype.getLastFilterText = function () {
        return this.item.lastFilterText === undefined ? '' : this.item.lastFilterText;
    };
    TransactionGridComponent.prototype.getFilteredSales = function (item) {
        if (!item.sortedAndFilteredItems) {
            item.sortedAndFilteredItems = item.sales.concat();
        }
        return item.sortedAndFilteredItems;
    };
    TransactionGridComponent.prototype.filterTransactionByText = function (e) {
        var target = e.target;
        ...
        var existingFilter = this.filterService.getExistingFilter(this.item.filterOptions, filterOption);
        if (existingFilter) {
            existingFilter.validFilterValues = [target.value];
        }
        else {
    ...
    TransactionGridComponent.prototype.filterItems = function (arr, filterOptions) {
        var copyArr = arr.concat();
        var len = filterOptions.length;
        for (var i = 0; i < len; i++) {
            var filterOption = filterOptions[i];
    ...
    TransactionGridComponent.prototype.getRoundedRatingText = function (rating) {
        rating = Math.round(rating) / 100;
        var starText = ' star';
        if (rating !== 1) {
            starText += 's';
    ...
    TransactionGridComponent.prototype.sortByVar = function (varName) {
        var _this = this;
        if (!this.item.filterOptions) {
            this.item.filterOptions = [];
        }
        ...
        this.item.sortedAndFilteredItems = this.item.sortedAndFilteredItems.sort(function (item1, item2) {
            if (item1[varName] > item2[varName]) {
                return _this.item.sortDirection;
            }
            if (item2[varName] > item1[varName]) {
                return -1 * _this.item.sortDirection;
            }
            return 0;
        });
    ...
    TransactionGridComponent.prototype.sortedDown = function (varName) {
        return varName === this.item.lastSortVar && this.item.sortDirection === 1;
    };
    TransactionGridComponent.prototype.sortedUp = function (varName) {
        return varName === this.item.lastSortVar && this.item.sortDirection === -1;
    };
    // Triggered when a details column row resize begins
    TransactionGridComponent.prototype.detailsColumnResizeStart = function (e) { };
    // Triggered when a details column row is resized via a mouse movemenet
    TransactionGridComponent.prototype.detailsColumnResize = function (e) { };
    // Triggered when a details column row is resize is completed
    TransactionGridComponent.prototype.detailsColumnResizeEnd = function (e) { };
    // Triggered when a parent column reorder begins
    TransactionGridComponent.prototype.detailsColumnReorderStart = function (e) { };
    // Triggered when a parent column is being reordered
    TransactionGridComponent.prototype.detailsColumnReorder = function (e) { };
    // Triggered when a parent column reorder ends
    TransactionGridComponent.prototype.detailsColumnReorderEnd = function (e) { };
    TransactionGridComponent.ctorParameters = function () { return [
        { type: core_1.ElementRef },
        { type: theme_service_1.ThemeService },
        { type: grid_data_service_1.GridDataService },
        { type: filter_service_1.FilterService }
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var filter_overlay_tokens_1 = __webpack_require__(/*! ./filters/filter-overlay-tokens */ "./src/app/components/phone-filter/filters/filter-overlay-tokens.ts");
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
var filter_type_1 = __webpack_require__(/*! ../../shared/classes/filter-type */ "./src/app/shared/classes/filter-type.ts");
var theme_service_1 = __webpack_require__(/*! ./../../services/theme/theme.service */ "./src/app/services/theme/theme.service.ts");
var PhoneFilterComponent = /** @class */ (function () {
    function PhoneFilterComponent(data, fb, themeService, elementRef) {
        this.data = data;
        this.fb = fb;
        this.themeService = themeService;
        this.elementRef = elementRef;
    ...
    PhoneFilterComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.themeService.themes.forEach(function (theme) {
            _this.elementRef.nativeElement.classList.add(theme);
        });
        ...
        this.areaCodes.forEach(function (item, index) {
            var checked = _this.preselectedCodes.indexOf(item) !== -1 ? true : false;
            group[_this.setId(index)] = new forms_1.FormControl(checked, []);
        });
        this.form = new forms_1.FormGroup(group);
    };
    PhoneFilterComponent.prototype.ngAfterViewInit = function () {
    };
    PhoneFilterComponent.prototype.setId = function (i) {
        return 'styled-checkbox-' + i;
    };
    PhoneFilterComponent.prototype.mixedCheckValues = function () {
        var _this = this;
        ...
        Object.keys(this.form.controls).forEach(function (key) {
            if (key !== 'select-all') {
                if (_this.form.controls[key].value === true) {
                    hasTrue = true;
                }
                else {
                    hasFalse = true;
    ...
    PhoneFilterComponent.prototype.checkboxChanged = function (e) {
        var _this = this;
        var checkbox = e.target;
        var id = checkbox.id;
        if (e.target === this.selectAllInput.nativeElement) {
            var selectAllValue = this.form.controls['select-all'].value;
    ...
    PhoneFilterComponent.prototype.setAllFormControlsTo = function (val) {
        var _this = this;
        Object.keys(this.form.controls).forEach(function (key) {
            if (key !== 'select-all') {
                _this.form.controls[key].setValue(val);
            }
        });
    };
    PhoneFilterComponent.prototype.resetFilter = function (e) {
        this.form.controls['select-all'].setValue(true);
        this.setAllFormControlsTo(true);
    };
    PhoneFilterComponent.prototype.onSubmit = function (form) {
        var formData = form.value;
        var codesToFilter = [];
        var i = 0;
    ...
    PhoneFilterComponent.ctorParameters = function () { return [
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var print_overlay_tokens_1 = __webpack_require__(/*! ./print/print-overlay-tokens */ "./src/app/components/print-overlay/print/print-overlay-tokens.ts");
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
var theme_service_1 = __webpack_require__(/*! ./../../services/theme/theme.service */ "./src/app/services/theme/theme.service.ts");
var print_options_service_1 = __webpack_require__(/*! ./../../services/print/print-options/print-options.service */ "./src/app/services/print/print-options/print-options.service.ts");
var PrintOverlayComponent = /** @class */ (function () {
    function PrintOverlayComponent(data, fb, themeService, printOptionsService, elementRef) {
        this.data = data;
        this.fb = fb;
        this.themeService = themeService;
    ...
    PrintOverlayComponent.prototype.ngOnInit = function () {
        var _this = this;
        var lastEmit = this.printOptionsService.lastEmit;
        ...
        this.form.valueChanges.subscribe(function (res) {
            if (!(_this.form.controls['rowStart'].errors || _this.form.controls['rowEnd'].errors)) {
                _this.disablePrint = false;
            }
            else {
                _this.disablePrint = true;
            }
            _this.updatePrintableItems(_this.form.controls['selectedRowsOnly'].value);
        });
    ...
    PrintOverlayComponent.prototype.updatePrintableItems = function (selectedOnly) {
        this.printableItems = selectedOnly ? this.getSelectedPrintableItems() : this.data.printableItems;
        this.printableItems = this.printableItems.slice(Number(this.form.controls['rowStart'].value) - 1, Number(this.form.controls['rowEnd'].value));
        var totalRows = this.calculateTotalRows();
        if (totalRows > this.maxRows || totalRows === 0) {
            this.disablePrint = true;
        }
    };
    PrintOverlayComponent.prototype.getSelectedPrintableItems = function () {
        return this.data.printableItems.filter(function (item) { return item.selected; });
    };
    PrintOverlayComponent.prototype.getMaxRows = function (rowLen) {
        return rowLen > this.maxRows ? this.maxRows : rowLen;
    };
    PrintOverlayComponent.prototype.includeTransActionsDisabled = function () {
        return !this.form.controls['selectedRowsOnly'].value;
    };
    PrintOverlayComponent.prototype.calculateTotalRows = function () {
        this.printHeight = 0;
        var rowEnd = Number(this.form.controls['rowEnd'].value);
        var rowStart = Number(this.form.controls['rowStart'].value);
        var totalCustomerRows = Math.min(rowEnd - rowStart + 1, this.printableItems.length);
        var transactionCount = 0;
        var includeTransactions = this.form.controls['includeTransactions'].value;
        if (includeTransactions) {
            this.printableItems.forEach(function (item) {
    ...
    PrintOverlayComponent.prototype.calculatePrintHeight = function (totalCustomerRows, transactionCount, includeTransactions) {
        // includes the padding height
        var extraHeight = includeTransactions ? 24 : 0;
        var singleHeaderHeight = includeTransactions ? this.themeService.getFullTableHeight(1) : 0;
    ...
    PrintOverlayComponent.prototype.maxRowValidator = function (maxRows) {
        return function (control) {
            if (control.parent) {
                var rowEnd = Number(control.parent.controls['rowEnd'].value);
                var rowStart = Number(control.parent.controls['rowStart'].value);
    ...
    PrintOverlayComponent.prototype.properRangeValidator = function () {
        return function (control) {
            if (control.parent) {
                var rowEnd = Number(control.parent.controls['rowEnd'].value);
                var rowStart = Number(control.parent.controls['rowStart'].value);
    ...
    PrintOverlayComponent.prototype.onlyNumbersValidator = function () {
        return function (control) {
            var reg = /^\d+$/;
    ...
    PrintOverlayComponent.prototype.controlChanged = function () {
        var _this = this;
        return function (control) {
            _this.data.containsPrintableItems = true;
            return null;
        };
    };
    PrintOverlayComponent.prototype.onSubmit = function (form) {
        if (form.invalid) {
            return;
        }
        var formData = form.value;
    ...
    PrintOverlayComponent.prototype.closePrintModal = function () {
        this.closeEmitter.emit();
    };
    PrintOverlayComponent.prototype.getMaximumRowsText = function () {
        return 'Maximum: ' + this.maxRows + ' rows ';
    };
    PrintOverlayComponent.prototype.selectedRowsChanged = function (e) {
        var target = e.target;
    };
    PrintOverlayComponent.prototype.includeTransactionsChanged = function (e) {
        var target = e.target;
    };
    PrintOverlayComponent.ctorParameters = function () { return [
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var selected_overlay_tokens_1 = __webpack_require__(/*! ./selected/selected-overlay-tokens */ "./src/app/components/selected-filter/selected/selected-overlay-tokens.ts");
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
var filter_type_1 = __webpack_require__(/*! ../../shared/classes/filter-type */ "./src/app/shared/classes/filter-type.ts");
var theme_service_1 = __webpack_require__(/*! ./../../services/theme/theme.service */ "./src/app/services/theme/theme.service.ts");
var SelectedFilterComponent = /** @class */ (function () {
    function SelectedFilterComponent(data, fb, themeService, elementRef) {
        this.data = data;
        this.fb = fb;
        this.themeService = themeService;
        this.elementRef = elementRef;
    ...
    SelectedFilterComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.themeService.themes.forEach(function (theme) {
            _this.elementRef.nativeElement.classList.add(theme);
        });
    ...
    SelectedFilterComponent.prototype.ngAfterViewInit = function () {
    };
    SelectedFilterComponent.prototype.mixedCheckValues = function () {
        var _this = this;
    ...
    SelectedFilterComponent.prototype.checkboxChanged = function (e) {
        var _this = this;
        var checkbox = e.target;
        var id = checkbox.id;
        if (e.target === this.selectAllInput.nativeElement) {
            var selectAllValue = this.form.controls['selectAll'].value;
            this.setAllFormControlsTo(selectAllValue);
        }
        else {
            if (this.form.controls[id].value === true) {
    ...
    SelectedFilterComponent.prototype.setAllFormControlsTo = function (val) {
        var _this = this;
        Object.keys(this.form.controls).forEach(function (key) {
            if (key !== 'selectAll') {
                _this.form.controls[key].setValue(val);
    ...
    SelectedFilterComponent.prototype.resetFilter = function (e) {
        this.form.controls['selectAll'].setValue(true);
        this.setAllFormControlsTo(true);
    };
    SelectedFilterComponent.prototype.onSubmit = function (form) {
        var formData = form.value;
        var filterType = filter_type_1.FilterType.EXACT_MATCH;
        var validFilterValues;
        ...
        var filterOption = {
            ...
            validFilterValues: validFilterValues
        };
        this.filterOptionEmitter.emit(filterOption);
    };
    SelectedFilterComponent.ctorParameters = function () { return [
    ...
    return SelectedFilterComponent;
}());
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var FpsMeterComponent = /** @class */ (function () {
    function FpsMeterComponent(cdr) {
        this.cdr = cdr;
        this.fps = 0;
        this.lastLoop = Date.now();
    }
    FpsMeterComponent.prototype.ngOnInit = function () {
        this.timeout();
    };
    FpsMeterComponent.prototype.frameLoop = function () {
    ...
    FpsMeterComponent.prototype.timeout = function () {
        var _this = this;
        setTimeout(function () {
            _this.frameLoop();
            _this.timeout();
    ...
    FpsMeterComponent.ctorParameters = function () { return [
        { type: core_1.ChangeDetectorRef }
    ]; };
...
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var common_1 = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
var fps_meter_component_1 = __webpack_require__(/*! ./components/fps-meter/fps-meter.component */ "./src/app/fps/components/fps-meter/fps-meter.component.ts");
var FramesPerSecondModule = /** @class */ (function () {
    function FramesPerSecondModule() {
    }
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var min_1 = __webpack_require__(/*! libphonenumber-js/min */ "./node_modules/libphonenumber-js/min/index.js");
var PhonePipe = /** @class */ (function () {
    function PhonePipe() {
    }
    PhonePipe.prototype.transform = function (phoneValue, country) {
        try {
            var phoneNumber = min_1.parsePhoneNumber(phoneValue + '', country);
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var CellValidatorService = /** @class */ (function () {
    function CellValidatorService() {
    }
    CellValidatorService.prototype.hasFirstAndLastName = function (content) {
        var names = content.split(' ');
        return names.length === 2 && names[1].length > 0; // regEx.test(content);
    };
    CellValidatorService.prototype.isNotEmpty = function (content) {
        return content.length > 0 && content.charAt(0) !== ' ';
    };
    CellValidatorService.prototype.itemExistsInList = function (item, list) {
        return list.indexOf(item) !== -1;
    };
    // Verify if email meets all requirements
    CellValidatorService.prototype.emailIsValid = function (email) {
...
var ExcelService = /** @class */ (function () {
    function ExcelService(phonePipe, currencyPipe) {
        this.phonePipe = phonePipe;
        this.currencyPipe = currencyPipe;
        this.wb = XLSX.utils.book_new();
    }
    ExcelService.prototype.saveWorkbookFromData = function (data, fileName, includeCustomerData, includeTransactionData) {
        if (includeCustomerData === void 0) { includeCustomerData = true; }
        if (includeTransactionData === void 0) { includeTransactionData = true; }
        this.wb = XLSX.utils.book_new();
        this.wb.Props = {
            Title: 'Customer Data',
        ...
        if (includeCustomerData) {
            ...
            var ws_data = this.generateCustomerData(data); // a row with 2 columns
        ...
        var wbout = XLSX.write(this.wb, { bookType: 'xlsx', type: 'binary' });
    ...
    ExcelService.prototype.generateCustomerData = function (data) {
        var _this = this;
        var customerData = [['ID', 'Name', 'Email', 'Phone Number', 'Sale Count', 'Gross Sales', 'Net Sales', 'Star Rating', 'Total Items Sold', 'Total Sales']];
        data.forEach(function (item) {
            customerData.push([
                item.id,
                item.name,
                item.email,
                _this.phonePipe.transform(item.phone, 'US'),
                item.sales.length,
                _this.currencyPipe.transform(item.gross),
                _this.currencyPipe.transform(item.net),
    ...
    ExcelService.prototype.generateCustomerTransactionsWorksheet = function (data) {
        var _this = this;
        var saleData = [];
        data.forEach(function (item, index) {
            ...
            item.sales.forEach(function (sale) {
                saleData.push([
                    sale.productName,
                    sale.quantity,
                    _this.currencyPipe.transform(sale.salePrice),
                    _this.currencyPipe.transform(sale.salePrice * sale.quantity),
                    _this.currencyPipe.transform(sale.shippingCost),
                    _this.currencyPipe.transform(sale.salePrice * sale.quantity - sale.shippingCost),
                    sale.starRating
                ]);
            });
            saleData.push([]);
        ...
        var ws = XLSX.utils.aoa_to_sheet(saleData);
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var ExportOptionsService = /** @class */ (function () {
    function ExportOptionsService() {
    }
    Object.defineProperty(ExportOptionsService.prototype, "exportOptionEmitter", {
        get: function () {
            return this._exportOptionEmitter;
        },
        set: function (optionEmitter) {
            var _this = this;
            this._exportOptionEmitter = optionEmitter;
            this._exportOptionEmitter.subscribe(function (emit) {
                _this._lastEmit = emit;
            });
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ExportOptionsService.prototype, "lastEmit", {
        get: function () {
...
var FilterService = /** @class */ (function () {
    ...
    FilterService.prototype.iterate = function (obj, option) {
        var _this = this;
        var containsValue = false;
        Object.keys(obj).forEach(function (key) {
            if (obj[key] instanceof Object) {
                if (_this.iterate(obj[key], option)) {
                    containsValue = true;
                }
            }
            else {
    ...
    FilterService.prototype.filter = function (arr, option, deep) {
        var _this = this;
        ...
        switch (option.filterType) {
            ...
            default:
                return arr.filter(function (item) {
                    var prop = item[option.varName];
                    for (var i = 0; i < option.validFilterValues.length; i++) {
                        switch (option.filterType) {
                            case filter_type_1.FilterType.SELECTED_AND_UNSELECTED:
                                if (_this.filterByExact(prop, true) || _this.filterByExact(prop, false)) {
                                    return true;
                                }
                                break;
                            case filter_type_1.FilterType.SELECTED:
                                if (_this.filterByExact(prop, true)) {
                                    return true;
                                }
                                break;
                            case filter_type_1.FilterType.UNSELECTED:
                                if (_this.filterByExact(prop, false)) {
                                    return true;
                                }
                                break;
                            case filter_type_1.FilterType.EXACT_MATCH:
                                if (_this.filterByExact(prop, option.validFilterValues[i])) {
                                    return true;
                                }
                                break;
                            case filter_type_1.FilterType.AREA_CODE:
                                if (_this.filterByAreaCode(prop, option.validFilterValues[i])) {
                                    return true;
                                }
                                break;
                        }
    ...
    FilterService.prototype.filterByExact = function (prop, filterValue) {
        return prop === filterValue;
    };
    FilterService.prototype.filterByAreaCode = function (prop, filterValue) {
        return prop.toString().substring(0, 3) === filterValue.toString();
    };
    FilterService.prototype.filterByText = function () {
        return true;
    };
    FilterService.prototype.getExistingFilter = function (filterOptions, filterOption) {
        return filterOptions.filter(function (item) {
...
var GridDataService = /** @class */ (function () {
    ...
    GridDataService.prototype.getAreaCodes = function () {
        return this.areaCodes;
    };
    GridDataService.prototype.generateGridData = function (count) {
        var index = 0;
        var baseItems = [];
        for (var i = 0; i < count; i++) {
            var name_1 = this.generateName();
            var item = {
                id: i,
                name: name_1,
                email: this.generateRandomEmail(name_1),
    ...
    GridDataService.prototype.calculateTotalGrossProductSales = function (item) {
        var gross = 0;
        for (var _i = 0, _a = item.sales; _i < _a.length; _i++) {
            var sale = _a[_i];
            gross += this.calculateItemSalePrice(sale);
        }
        return gross;
    };
    GridDataService.prototype.calculateTotalNetProductSales = function (item) {
        var net = 0;
        for (var _i = 0, _a = item.sales; _i < _a.length; _i++) {
            var sale = _a[_i];
    ...
    GridDataService.prototype.calculateAverageStarPercent = function (item) {
        var medianRating = 0;
        for (var _i = 0, _a = item.sales; _i < _a.length; _i++) {
            var sale = _a[_i];
    ...
    GridDataService.prototype.calculateStarPercent = function (sale) {
        return sale.starRating / 5 * 100;
    };
    GridDataService.prototype.calculateItemNetProfit = function (sale) {
        return this.calculateItemSalePrice(sale) - sale.shippingCost;
    };
    GridDataService.prototype.calculateItemSalePrice = function (sale) {
        return sale.salePrice * sale.quantity;
    };
    GridDataService.prototype.calculateTotalItemsSold = function (sales) {
        return sales.map(function (sale) { return sale.quantity; }).reduce(function (prev, curr) { return prev + curr; });
    };
    GridDataService.prototype.generateName = function () {
        var randFirstName = this.firstNames[Math.floor(Math.random() * this.firstNames.length)];
        var randLastName = this.lastNames[Math.floor(Math.random() * this.lastNames.length)];
        return randFirstName + ' ' + randLastName;
    };
    GridDataService.prototype.generateRandomEmail = function (name) {
        var names = name.split(' ');
        var firstName = names[0].toLowerCase();
        var lastName = names[1].toLowerCase();
        var separator = this.separators[Math.floor(Math.random() * this.separators.length)];
        var domain = this.domains[Math.floor(Math.random() * this.domains.length)].toLowerCase();
        return firstName + separator + lastName + '@' + domain;
    };
    GridDataService.prototype.generateRandomPhoneNumber = function () {
        var areaCode = this.areaCodes[Math.floor(Math.random() * this.areaCodes.length)].toString();
    ...
    GridDataService.prototype.generateRandomSales = function () {
        var sales = [];
        var totalTransactions = Math.random() * this.maxSales;
        for (var i = 0; i < totalTransactions; i++) {
            var productIndex = Math.floor(Math.random() * this.products.length);
            var quantity = Math.ceil(Math.random() * 5);
            var selectedProduct = this.products[productIndex];
            sales.push({
                quantity: quantity,
    ...
    GridDataService.prototype.generateSalePrice = function (saleRange) {
        var price = Math.random() * (saleRange[1] - saleRange[0]) + saleRange[0];
        price = Math.round(price * 100) / 100;
        return price;
    };
    GridDataService.prototype.generateShippingCost = function (shippingRange) {
        var cost = Math.random() * (shippingRange[1] - shippingRange[0]) + shippingRange[0];
        cost = Math.round(cost * 100) / 100;
        return cost;
    };
    GridDataService.prototype.generateRandomStarRating = function () {
        var rating = Math.random() * 100;
        if (rating > 50) {
            return 5;
        }
        else if (rating > 25) {
    ...
    GridDataService.prototype.pseudoRandom = function () {
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var PrintOptionsService = /** @class */ (function () {
    function PrintOptionsService() {
    }
    Object.defineProperty(PrintOptionsService.prototype, "printOptionEmitter", {
        get: function () {
        ...
        set: function (optionEmitter) {
            ...
            this._printOptionEmitter.subscribe(function (emit) {
                _this._lastEmit = emit;
            });
        },
        enumerable: true,
    ...
    Object.defineProperty(PrintOptionsService.prototype, "lastEmit", {
        get: function () {
            return this._lastEmit;
        },
        enumerable: true,
...
var ThemeService = /** @class */ (function () {
    ...
    ThemeService.prototype.setThemeColor = function (color) {
        this.themeColor = color;
        this.themeChanged.emit();
    };
    ThemeService.prototype.setThemeSize = function (size) {
        this.themeSize = size;
        this.themeChanged.emit();
    };
    ThemeService.prototype.getFullTableHeight = function (numOfItems) {
...
var DragAndDropGhostComponent = /** @class */ (function () {
    function DragAndDropGhostComponent() {
        this.show = false;
        this.left = 0;
        this.top = 0;
    }
    DragAndDropGhostComponent.prototype.ngOnInit = function () {
    };
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var column_reorder_event_1 = __webpack_require__(/*! ./../../shared/classes/events/column-reorder-event */ "./src/app/tablejs/shared/classes/events/column-reorder-event.ts");
var column_resize_event_1 = __webpack_require__(/*! ./../../shared/classes/events/column-resize-event */ "./src/app/tablejs/shared/classes/events/column-resize-event.ts");
...
var HorizResizeGripComponent = /** @class */ (function () {
    ...
    HorizResizeGripComponent.prototype.ngOnInit = function () {
    };
...
var ReorderGripComponent = /** @class */ (function () {
    ...
    ReorderGripComponent.prototype.ngOnInit = function () {
    };
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var grid_service_1 = __webpack_require__(/*! ./../../services/grid/grid.service */ "./src/app/tablejs/services/grid/grid.service.ts");
var DataColClassDirective = /** @class */ (function () {
    ...
    DataColClassDirective.prototype.registerInitialColumnWidthOnOnGridDirective = function () {
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var drag_and_drop_ghost_component_1 = __webpack_require__(/*! ./../../components/drag-and-drop-ghost/drag-and-drop-ghost.component */ "./src/app/tablejs/components/drag-and-drop-ghost/drag-and-drop-ghost.component.ts");
var domtoimage = __webpack_require__(/*! dom-to-image-improved */ "./node_modules/dom-to-image-improved/src/dom-to-image-improved.js");
var tablejs_grid_proxy_1 = __webpack_require__(/*! ./../../shared/classes/tablejs-grid-proxy */ "./src/app/tablejs/shared/classes/tablejs-grid-proxy.ts");
var grid_service_1 = __webpack_require__(/*! ./../../services/grid/grid.service */ "./src/app/tablejs/services/grid/grid.service.ts");
var column_reorder_event_1 = __webpack_require__(/*! ./../../shared/classes/events/column-reorder-event */ "./src/app/tablejs/shared/classes/events/column-reorder-event.ts");
var column_resize_event_1 = __webpack_require__(/*! ./../../shared/classes/events/column-resize-event */ "./src/app/tablejs/shared/classes/events/column-resize-event.ts");
var GridDirective = /** @class */ (function (_super) {
    tslib_1.__extends(GridDirective, _super);
    function GridDirective(viewContainerRef, elementRef, resolver, gridService) {
        ...
        _this.headTag = document.getElementsByTagName('head')[0];
        _this.initialWidths = [];
        _this.lastColumns = [];
        _this.parentGroups = [];
        _this.colDataGroups = [];
        ...
        _this.columnResizeStart = new core_1.EventEmitter();
        _this.columnResize = new core_1.EventEmitter();
        _this.columnResizeEnd = new core_1.EventEmitter();
        _this.columnReorder = new core_1.EventEmitter();
        _this.columnReorderStart = new core_1.EventEmitter();
        _this.dragOver = new core_1.EventEmitter();
        _this.columnReorderEnd = new core_1.EventEmitter();
    ...
    GridDirective.prototype.onPointerDown = function (event) {
        ...
        if (reorderHandlesUnderPoint.length > 0 && colsUnderPoint.length > 0) {
            ...
            var customReorderStartEvent = new CustomEvent(column_reorder_event_1.ColumnReorderEvent.ON_REORDER_START, {
                detail: {
                    pointerEvent: event,
                    columnDragged: this.draggingColumn,
                    columnHovered: this.draggingColumn
        ...
        elements.forEach(function (resizeableElement) {
            _this.lastColumns.forEach(function (lastColumns) {
                if ((resizeableElement === lastColumns.child) && _this.resizeColumnWidthByPercent) {
                    _this.dragging = false;
                }
            });
        });
        this.currentClassesToResize.forEach(function (className) {
            ...
            var startingWidth = window.getComputedStyle(firstEl).getPropertyValue('width');
            var wdth = Number(startingWidth.substr(0, startingWidth.length - 2)); // remove px
        ...
        var customResizeStartEvent = new CustomEvent(column_resize_event_1.ColumnResizeEvent.ON_RESIZE_START, {
            detail: {
                pointerEvent: event,
                columnWidth: this.totalComputedWidth,
                columnMinWidth: this.totalComputedMinWidth,
    ...
    GridDirective.prototype.copyColumnToJPeg = function () {
        var _this = this;
        domtoimage.toPng(this.draggingColumn, { quality: 0.9, filter: this.dragAndDropGhostFilter })
            .then(function (dataUrl) {
            var img = new Image();
            img.src = dataUrl;
            _this.setDragAndDropHTML(img.outerHTML);
        })
    ...
    GridDirective.prototype.onPointerMove = function (event) {
        ...
        if (ths.elementRef.nativeElement.reordering) {
            ths.clearSelection();
            var containerRect = ths.viewContainerRef.element.nativeElement.getBoundingClientRect();
            var dragNDropX = event.clientX - containerRect.left - ths.dragOffsetX;
            var dragNDropY = event.clientY - containerRect.top - ths.dragOffsetY;
            ths.setDragAndDropPosition(dragNDropX, dragNDropY);
            var reorderCols = this.reorderableColumns;
            ...
            var customReorderEvent = new CustomEvent(column_reorder_event_1.ColumnReorderEvent.ON_REORDER, {
                detail: {
                    pointerEvent: event,
                    columnDragged: ths.draggingColumn,
                    columnHovered: ths.lastDraggedOverElement
            ...
            for (var _i = 0, _a = ths.lastDraggedGroupBoundingRects; _i < _a.length; _i++) {
                var rect = _a[_i];
            ...
            var pGroup = ths.parentGroups.forEach(function (group, groupInd) {
                return group.forEach(function (item, index) {
                    if (item === ths.draggingColumn) {
                        colRangeDraggedParentInd_1 = groupInd;
                        colRangeDraggedChildInd_1 = index;
                        draggedInd_1 = index;
                        draggedGroup_1 = group;
                    }
                    if (item === ths.lastDraggedOverElement) {
                        colRangeDroppedParentInd_1 = groupInd;
                        colRangeDroppedChildInd_1 = index;
                        droppedInd_1 = index;
                    }
                });
            });
        ...
        var customResizeEvent = new CustomEvent(column_resize_event_1.ColumnResizeEvent.ON_RESIZE, {
            detail: {
                pointerEvent: event,
                columnWidth: ths.totalComputedWidth,
                columnMinWidth: ths.totalComputedMinWidth
    ...
    GridDirective.prototype.updateWidths = function (newWidth) {
        ...
        var currentWidths = [];
        var styles = [];
        var cssClassesToFilter = this.currentClassesToResize.filter(function (resizeClass) {
            var firstEl = _this.elementRef.nativeElement.querySelector('.' + resizeClass);
            var wdth = window.getComputedStyle(firstEl).getPropertyValue('width');
            wdth = wdth.substr(0, wdth.length - 2); // remove px
            currentWidths.push(Number(wdth));
            var found = false;
            _this.stylesByClass.map(function (item, index) {
                if (resizeClass === item.resizeClass) {
                    found = true;
                    styles.push(_this.stylesByClass[index]);
                }
            });
            return found;
        });
        var sortableWidths = [];
        currentWidths.map(function (w, index) {
            sortableWidths.push({
                minWidth: _this.minWidths[index],
                width: w,
                widthDifference: w - _this.minWidths[index],
                className: cssClassesToFilter[index],
                style: styles[index]
            });
        });
        // sort objects by width in ascending order
        sortableWidths.sort(function (a, b) {
        ...
        sortableWidths.forEach(function (item, index) {
            var itemsRemaining = len - index;
            var maxPercOfRemaining = 1 / itemsRemaining;
            var amountMoved = 0;
            ...
            if (item.width - item.minWidth < maxPercOfRemaining * remainingWidth) {
                var maxMovement = item.width - item.minWidth;
            ...
            if (_this.classWidths[_this.gridTemplateClasses.indexOf(item.className)].toString().includes('%')) {
                var columnIndex = _this.gridTemplateClasses.indexOf(item.className);
                var currentWidthInpercent = _this.classWidths[_this.gridTemplateClasses.indexOf(item.className)].replace('%', '');
                currentWidthInpercent = Number(currentWidthInpercent);
                var currentWidthInPixel = item.width;
                var totalWidth = (currentWidthInPixel * 100) / currentWidthInpercent;
                var adujustedWidth = (item.width - amountMoved);
                var adujustedWidthInpercent = ((adujustedWidth * 100) / totalWidth);
                adujustedWidthInpercent = Math.round(adujustedWidthInpercent * 1000) / 1000;
                var widthDiff = currentWidthInpercent - adujustedWidthInpercent;
                var t = Math.round(widthDiff * 1000) / 1000; // round off to three
                var maxIndex_1 = -1;
                sortableWidths.forEach(function (classItem) {
                    var columnIndx = _this.gridTemplateClasses.indexOf(classItem.className);
                    var x = _this.gridOrder.indexOf(columnIndx + 1);
                    if (maxIndex_1 < x) {
                        maxIndex_1 = x;
                    }
                });
                var tc = _this.gridOrder.length - (maxIndex_1 + 1); // adjust from next column
                var previousVal = _this.classWidths[columnIndex];
                _this.classWidths[columnIndex] = adujustedWidthInpercent + '%';
                var totalSum = 0;
                for (var it = 0; it < _this.classWidths.length; it++) {
                    var temp = _this.classWidths[it];
                ...
                var percolumn = totalDiff / tc;
                percolumn = Math.round(percolumn * 1000) / 1000;
                for (var i = maxIndex_1 + 1; i < _this.gridOrder.length; i++) {
                    var classIndex = _this.gridOrder[i] - 1;
                    var x = _this.classWidths[classIndex];
                    if (x.toString().includes('%')) {
                        x = x.replace('%', '');
                    }
                    var width = Math.round(((+x) + percolumn) * 1000) / 1000;
                    if (width < 1) {
                        percolumn = percolumn + (percolumn / ((_this.gridOrder.length - 1) - i));
                        if (!isFinite(percolumn)) {
                            _this.classWidths[columnIndex] = previousVal;
                        }
                    }
                    else {
                        _this.classWidths[classIndex] = ((+x) + percolumn).toFixed(2) + '%';
                    }
                }
            }
            else {
                _this.classWidths[_this.gridTemplateClasses.indexOf(item.className)] = (item.width - amountMoved);
            }
            var gridTemplateColumns = _this.constructGridTemplateColumns();
            _this.gridTemplateTypes.forEach(function (styleObj) {
            ...
            if (markupItem.width.toString().includes('%')) {
                var currentWidthInpercent = markupItem.width.replace('%', '');
                currentWidthInpercent = Number(currentWidthInpercent);
                var currentWidthInPixel = item.width;
                var totalWidth = (currentWidthInPixel * 100) / currentWidthInpercent;
                var adujustedWidth = (item.width - amountMoved);
                var adujustedWidthInpercent = ((adujustedWidth * 100) / totalWidth).toFixed(2);
    ...
    GridDirective.prototype.onPointerUp = function (event) {
        ...
        if (ths.elementRef.nativeElement.reordering) {
            ...
            var customReorderEndEvent = new CustomEvent(column_reorder_event_1.ColumnReorderEvent.ON_REORDER_END, {
                detail: {
                    pointerEvent: event,
                    columnDragged: ths.draggingColumn,
                    columnHovered: ths.lastDraggedOverElement
        ...
        var customResizeEndEvent = new CustomEvent(column_resize_event_1.ColumnResizeEvent.ON_RESIZE_END, {
            detail: {
                pointerEvent: event,
                columnWidth: ths.totalComputedWidth,
                columnMinWidth: ths.totalComputedMinWidth,
    ...
    GridDirective.prototype.initGrid = function () {
        ...
        if (this.linkClass !== undefined && this.gridService.linkedDirectiveObjs[this.linkClass].classWidths) {
            ...
            this.classWidths = this.stylesByClass.map(function (styleObj, index) {
    ...
    GridDirective.prototype.createDragAndDropComponent = function () {
        var factory = this.resolver.resolveComponentFactory(drag_and_drop_ghost_component_1.DragAndDropGhostComponent);
    ...
    GridDirective.prototype.setDragAndDropHTML = function (html) {
    ...
    GridDirective.prototype.generateColumnGroups = function () {
        if (this.linkClass && this.gridService.linkedDirectiveObjs[this.linkClass].colDataGroups) {
            ...
            for (var index = 0; index < arr.length; index++) {
                item = arr[index];
                var lastDataSpan = !!this.colData ? this.colData.span : 0;
                if (item.parentElement !== lastParent) {
                    if (index !== 0) {
                        colOrder = 1;
    ...
    GridDirective.prototype.generateSubGroup = function (currentGroup, subGroup) {
        ...
        currentGroup.forEach(function (group, index) {
            ...
            for (var i = 0; i < groupSpan; i++) {
                group.subGroups.push(subGroup[indexCount]);
                indexCount++;
            }
        });
    };
    GridDirective.prototype.orderSubGroups = function (columnGroup, columnPlacement, placementStart, parentOrder) {
        var _this = this;
        if (columnPlacement === void 0) { columnPlacement = 1; }
        if (placementStart === void 0) { placementStart = 0; }
        if (parentOrder === void 0) { parentOrder = 1; }
        var style;
        var containerID;
        var fragment;
        var selector;
        ...
        columnGroup.forEach(function (columnData) {
            ...
            if (_this.parentGroups[parentIndex]) {
                if ((_this.parentGroups[parentIndex].length) === (columnData.order + placementStart)) {
                    _this.lastColumns[parentIndex] = columnData;
                }
            }
            if (_this.subGroupStyleObjs[selector]) {
                fragment.appendChild(style);
                _this.headTag.appendChild(fragment);
            }
            _this.subGroupStyleObjs[selector] = style;
            if (columnData.subGroups.length > 0) {
                _this.orderSubGroups(columnData.subGroups, columnPlacement, placementStart, columnData.lastDataSpan);
            }
            else {
                ...
                _this.subGroupStyleObjs[selector] = style;
                _this.gridOrder[(columnData.order + placementStart) - 1] = columnData.nthChild;
    ...
    GridDirective.prototype.setGridOrder = function () {
        ...
        this.colDataGroups.forEach(function (columnGroup, index) {
            var containerID = columnGroup[0].parent.getAttribute('id');
            var style;
            var fragment;
            ...
            style.innerHTML = _this.id + ' .' + _this.reorderableClass + ' { display: grid; grid-template-columns: ' + gridTemplateColumns + '; }';
            fragment.appendChild(style);
            if (reqiresNewStyleObjects) {
            ...
            _this.headTag.appendChild(fragment);
            _this.gridTemplateTypes.push({ id: containerID, style: style });
            if (index === 0) {
    ...
    GridDirective.prototype.reorderColumns = function (event) {
        ...
        var pGroup = this.parentGroups.forEach(function (group, groupInd) {
            return group.forEach(function (item, index) {
        ...
        if (parentRanges !== null) {
            this.colRangeGroups[parentRangeIndex].forEach(function (range) {
                var lowRange = range[0];
                var highRange = range[1];
                var draggedLowRange = _this.colRangeGroups[colRangeDraggedParentInd][colRangeDraggedChildInd][0];
                var draggedHighRange = _this.colRangeGroups[colRangeDraggedParentInd][colRangeDraggedChildInd][1];
                if (fromOrder >= lowRange && fromOrder < highRange && toOrder >= lowRange && toOrder < highRange) {
                    ...
                    var origRangGroup = rangeGroup.concat();
    ...
    GridDirective.prototype.constructGridTemplateColumns = function () {
        ...
        this.gridOrder.forEach(function (order, index) {
            if (_this.classWidths[order - 1].toString().includes('%')) {
                str += ' ' + _this.classWidths[order - 1].toString();
            }
            else {
                str += ' ' + _this.classWidths[order - 1].toString() + 'px';
            }
        });
        return str;
    };
    ...
    GridDirective.prototype.addResizableGrip = function (el) {
        this.resizableGrips.push(el);
    };
    GridDirective.prototype.addResizableColumn = function (el) {
        this.resizableColumns.push(el);
    };
    GridDirective.prototype.addReorderGrip = function (el) {
        this.reorderGrips.push(el);
    };
    GridDirective.prototype.addReorderableColumn = function (el) {
        this.reorderableColumns.push(el);
    };
    GridDirective.prototype.addColumnsWithDataClasses = function (el) {
        this.columnsWithDataClasses.push(el);
    };
    GridDirective.prototype.addRow = function (el) {
        this.rows.push(el);
    };
    GridDirective.prototype.addInfiniteScrollViewport = function (el) {
...
}(tablejs_grid_proxy_1.TablejsGridProxy));
...
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var grid_service_1 = __webpack_require__(/*! ./../../services/grid/grid.service */ "./src/app/tablejs/services/grid/grid.service.ts");
var ResizableColDirective = /** @class */ (function () {
    function ResizableColDirective(elementRef, gridService) {
        this.elementRef = elementRef;
        this.gridService = gridService;
    }
    ResizableColDirective.prototype.ngAfterViewInit = function () {
        this.registerColumnOnGridDirective();
    };
    ResizableColDirective.prototype.registerColumnOnGridDirective = function () {
        var el = this.gridService.getParentTablejsGridDirective(this.elementRef.nativeElement);
        if (el !== null) {
            el['gridDirective'].addResizableColumn(this.elementRef.nativeElement);
        }
    };
    ResizableColDirective.ctorParameters = function () { return [
        { type: core_1.ElementRef },
        { type: grid_service_1.GridService }
    ]; };
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var SortableColDirective = /** @class */ (function () {
    function SortableColDirective() {
    }
...
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var common_1 = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
var scrolling_1 = __webpack_require__(/*! @angular/cdk-experimental/scrolling */ "./node_modules/@angular/cdk-experimental/esm5/scrolling.es5.js");
var scrolling_2 = __webpack_require__(/*! @angular/cdk/scrolling */ "./node_modules/@angular/cdk/esm5/scrolling.es5.js");
var horiz_resize_grip_component_1 = __webpack_require__(/*! ./components/horiz-resize-grip/horiz-resize-grip.component */ "./src/app/tablejs/components/horiz-resize-grip/horiz-resize-grip.component.ts");
var reorder_grip_component_1 = __webpack_require__(/*! ./components/reorder-grip/reorder-grip.component */ "./src/app/tablejs/components/reorder-grip/reorder-grip.component.ts");
var grid_directive_1 = __webpack_require__(/*! ./directives/grid/grid.directive */ "./src/app/tablejs/directives/grid/grid.directive.ts");
var grid_row_directive_1 = __webpack_require__(/*! ./directives/grid-row/grid-row.directive */ "./src/app/tablejs/directives/grid-row/grid-row.directive.ts");
var resizable_grip_directive_1 = __webpack_require__(/*! ./directives/resizable-grip/resizable-grip.directive */ "./src/app/tablejs/directives/resizable-grip/resizable-grip.directive.ts");
var infinite_scroll_directive_1 = __webpack_require__(/*! ./directives/inifinite-scroll/infinite-scroll.directive */ "./src/app/tablejs/directives/inifinite-scroll/infinite-scroll.directive.ts");
var grid_component_1 = __webpack_require__(/*! ./components/grid/grid.component */ "./src/app/tablejs/components/grid/grid.component.ts");
var sortable_col_directive_1 = __webpack_require__(/*! ./directives/sortable-col/sortable-col.directive */ "./src/app/tablejs/directives/sortable-col/sortable-col.directive.ts");
var editable_cell_directive_1 = __webpack_require__(/*! ./directives/editable-cell/editable-cell.directive */ "./src/app/tablejs/directives/editable-cell/editable-cell.directive.ts");
var drag_and_drop_ghost_component_1 = __webpack_require__(/*! ./components/drag-and-drop-ghost/drag-and-drop-ghost.component */ "./src/app/tablejs/components/drag-and-drop-ghost/drag-and-drop-ghost.component.ts");
var resizable_col_directive_1 = __webpack_require__(/*! ./directives/resizable-col/resizable-col.directive */ "./src/app/tablejs/directives/resizable-col/resizable-col.directive.ts");
var reorder_grip_directive_1 = __webpack_require__(/*! ./directives/reorder-grip/reorder-grip.directive */ "./src/app/tablejs/directives/reorder-grip/reorder-grip.directive.ts");
var reorder_col_directive_1 = __webpack_require__(/*! ./directives/reorder-col/reorder-col.directive */ "./src/app/tablejs/directives/reorder-col/reorder-col.directive.ts");
var data_col_classes_directive_1 = __webpack_require__(/*! ./directives/data-col-classes/data-col-classes.directive */ "./src/app/tablejs/directives/data-col-classes/data-col-classes.directive.ts");
var data_col_class_directive_1 = __webpack_require__(/*! ./directives/data-col-class/data-col-class.directive */ "./src/app/tablejs/directives/data-col-class/data-col-class.directive.ts");
